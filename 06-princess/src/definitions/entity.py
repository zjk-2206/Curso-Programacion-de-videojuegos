...
ENTITY_DEFS: Dict[str, Dict[str, Any]] = {
    "player": {
        ...
        "animations": {
            ...
            "port-row": {"frames": [1], "texture": "character-port-row"},
            "shoot-left": {"frames": [7], "texture": "character-shoot"},
            "shoot-right": {"frames": [5], "texture": "character-shoot"},
            "shoot-up": {"frames": [3], "texture": "character-shoot"},
            "shoot-down": {"frames": [1], "texture": "character-shoot"},            
        },
    },
    "skeleton": {
        "texture": "entities",
