...
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_SPACE, "launch_ball")
input_handler.InputHandler.set_keyboard_action(input_handler.KEY_m, "rocket_ball")
...
SOUNDS = {
    ...
    "launch_rocket": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "rocket-sound.wav"),
    "rockets": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "gunreload.wav"),
    "winner1": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "winner1.wav"),
    "winner2": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "winner2.wav"),
    "boom": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "booom.wav"),
}
