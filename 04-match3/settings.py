...
SOUNDS = {
    ...
    "re-org": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "re-org.wav"),
    "clear_line": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "slashmeow.wav"),
    "color_bomb": pygame.mixer.Sound(BASE_DIR / "assets" / "sounds" / "color_bomb.wav"),
}
