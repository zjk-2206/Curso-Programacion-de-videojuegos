...
class GameLevel:
    def __init__(self, num_level: int) -> None:
        ...
        for obj in self.tilemap.object_layers.get("bricks", []):
            self.add_item(
                {
                    "item_name": "bricks",
                    "frame_index": obj.properties["frame_index"],
    ...
    def spawn_key(self, x: int, y: int) -> None:
        if self.spawn_keyed:
            return
        
        self.spawn_keyed = True
